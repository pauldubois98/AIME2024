...
\begin{document}
	\title{Radiotherapy Dose Optimization with Clinical Knowledge Based Reinforcement Learning}
	\titlerunning{Radiotherapy Optimization with Clinical Knowledge}
	
	\author{Paul Dubois\inst{1,2,3}\orcidID{0000-1111-2222-3333}
		\and \\
		Paul-Henry Cournède \inst{1}\orcidID{1111-2222-3333-4444}
		\and \\
		Nikos Paragios\inst{2}\orcidID{2222--3333-4444-5555}
%		\and\\
%		Rafael Marini-Silva\inst{2}\orcidID{0000--0000-0000-0000}
%		\and\\
%		Norbert Bus\inst{2}\orcidID{0000--0000-0000-0000}
%		\and\\
%		Nikos Komodakis\inst{2}\orcidID{0000--0000-0000-0000}
%		\and\\
%		Pascal Fenoglietto\inst{3}\orcidID{0000--0000-0000-0000}
	}
