...
%Additionally, directly predicting the next state evaluation bypasses the need for reward shaping, which can be challenging in complex optimization tasks.
...
% This study demonstrates the feasibility and potential benefits of deep RL for automating radiotherapy treatment plan optimization.
