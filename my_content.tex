...
This suggests the use of deep reinforcement learning, over expert base methods.
...
%This comforted the idea that our network was learning from data, without blindly over-fitting.
...
\begin{figure*}
	...
	\caption{Main axial slice (center of the PTV) CT of the first patient generated.}
...
\begin{figure*}
	...
	\caption{Main axial slice (center of the PTV) dose of the first patient generated.}
