...
On average, our model was able to reduce the dose distance with manual optimized dose by a factor of $10$ (from $1.94$ at iteration $0$ to $0.18$ at iteration $4$), as shown on figure.
...
\begin{figure*}
	...
	\caption{RL Agent DVHs after each action taken on a test (unseen) patient.}
	\label{fig:steps}
\end{figure*}
