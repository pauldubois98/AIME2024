...
On average, our model was able to reduce the dose distance with manually optimized dose by a factor of $8$ (from $1.94$ at iteration $1$ to $0.18$ at iteration $4$), as shown in the table \ref{table:results}.
...
Figure \ref{fig:steps} is the detail of the DVHs at each of the five steps of an optimization.
Our model was able to reduce the dose distance with manually optimized dose by a factor of $10$ (from $1.94$ at iteration $1$ to $0.18$ at iteration $4$).
